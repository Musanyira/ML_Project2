...
def user_input():
    ...
    hive_type = st.selectbox('Hive Type', ['Langstroth', 'Top-Bar', 'Traditional'])
    ...
    disease_status = st.selectbox('Disease Status', ['Healthy', 'Foulbrood', 'Varroa Mites', 'Nosema'])
    forage_availability = st.selectbox('Forage Availability', ['Low', 'Medium', 'High'])
    season = st.selectbox('Season', ['Dry', 'Rainy', 'Transitional'])
